...

{
  ...
  home.file = {
    ".config/mpv/scripts/modernx.lua".source = ./osc/modernx.lua;
    ".config/mpv/fonts/modernx-osc-icon.ttf".source = ./osc/modernx-osc-icon.ttf;
    ".config/mpv/scripts/crop.lua".source = ./crop.lua;
    ".config/mpv/scripts/auto-save-state.lua".source = ./auto-save-state.lua;
    ".config/mpv/scripts/locatefile.lua".source = ./locatefile.lua;
    ".config/mpv/script-modules/extended-menu.lua".source = ./extended-menu.lua;

    # ".config/mpv/scripts/leader.lua".source = ./leader/leader.lua;
    # ".config/mpv/script-modules/leader.lua".source = ./leader/leader-module.lua;
    # jellyfin
    # ".config/mpv/scripts/jellyfin.lua".source = ./jellyfin/jellyfin.lua;
    #crop
